          ...
          <div className={"flex justify-center"}>
              <div className={"flex flex-col items-center"}>
                  ...
                  <strong className={"mt-5"}>
                      <a className={"text-2xl sm:text-2xl md:text-4xl lg:text-4xl text-decoration-line: underline visited:text-purple-600 hover:text-orange-400 active:text-blue-600"}
                  ...
                  <strong className={"mt-3"}>
                      <a className={"visited:text-green-600 text-2xl sm:text-2xl md:text-4xl lg:text-4xl text-decoration-line: underline hover:text-orange-400 active:text-blue-600"}
