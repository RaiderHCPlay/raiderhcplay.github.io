  ...
  return (
      ...
      <div className={"flex justify-center"}>
          ...
          <div className={"flex flex-col items-center pl-16 pt-14"}>
              <h1 className={"text-orange-400 text-8xl lg:text-8xl md:text-7xl sm:text-8xl"}>RaiderHCPlay</h1>
              <strong><h2 className={"lg:text-5xl text-5xl md:text-4xl sm:text-5xl pt-4 text-typescript"}><span>TypeScript </span><span>Developer</span>
              </h2></strong>
              <strong className={"mt-5"}><a className={"text-purple-600 text-4xl lg:text-4xl md:text-3xl sm:text-4xl"}
                                            href="https://github.com/RaiderHCPlay"><h2 id="githubLink">GitHub Profile
                  Link</h2></a></strong>
              <strong className={"mt-5"}><a className={"text-green-600 text-4xl lg:text-4xl md:text-3xl sm:text-4xl"}
