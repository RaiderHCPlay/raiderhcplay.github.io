...
export default function About() {
    return <div id="aboutMe"
                className={"flex flex-col items-center pt-14 animate-fade-down animate-duration-[2000ms] animate-ease-out"}>
        ...
        <ul className={"text-2xl md:text-4xl max-w-7xl text-center"}>Learning:
                ...
                <svg width="100%" height="100%" viewBox="-10.5 -9.45 21 18.9" fill="none"
                    ...
                    <g stroke="currentColor" stroke-width="1" fill="none">
                        ...
                        <ellipse rx="10" ry="4.5" transform="rotate(120)"></ellipse>
                         ...
                         className={"hover:underline hover:text-[#89dceb]"}>React
            </a></li>
            ...
            /> <a href={"https://nextjs.org/"} target={"_blank"}
                 className={"hover:underline hover:text-[#45475a]"}>Next.js</a>
            </li>
            <li className={"pt-1"}><Image
                alt={"Tailwind Logo"}
                width={"50"}
            ...
            /><a href={"https://tailwindcss.com/"} target={"_blank"}
                 className={"hover:underline hover:text-[#89b4fa]"}>Tailwind CSS
            </a></li>
        </ul>
    </div>;
}