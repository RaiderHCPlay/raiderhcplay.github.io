...
export default function Introduction() {
    return (
        <div
            className={"flex-col md:flex-row flex justify-center items-center animate-fade-down animate-duration-[2000ms] w-[500px] md:w-[750px] m-auto border-[#94e2d5] border-[3px] mt-2.5"}>
