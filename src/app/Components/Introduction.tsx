...
export default function Introduction() {
    return (
        <div
            className={
                'flex-col md:flex-row flex justify-center items-center animate-fade-down animate-duration-[2000ms] w-[325px] md:w-[750px] m-auto border-[#a6e3a1] border-[3px] mt-2.5 p-3.5'
            }
        >
            ...
            <div className={'flex flex-col items-center md:ml-14'}>
                ...
                <h2 className={'text-[#a6e3a1] text-[20px] md:text-2xl mt-2'}>
                    (also known as <strong>RaiderHCPlay</strong>)
                </h2>
                ...
                <strong className={'mt-2 md:mt-5'}>
                    <a
                        className={
                            'text-[20px] md:text-3xl underline hover:text-[#a6e3a1] active:text-[#cba6f7]'
                        }
