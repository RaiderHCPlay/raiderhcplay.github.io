...
export default function About() {
    return (
        <div
            className={
                'text-center animate-fade-down animate-duration-[2000ms] animate-ease-out border-[#a6e3a1] border-[3px] w-[400px] h-[555px] md:w-[1200px] md:h-[600px] m-auto mt-2.5'
            }
        >
            <div
                className={
                    'border-[#a6e3a1] border-b-[3px] h-[200px] w-full md:h-[250px] flex flex-col items-center'
                }
            >
                <h1
                    className={
                        'text-[30px] md:text-5xl border-[#a6e3a1] border-b-[3px] border-l-[3px] border-r-[3px] pl-4 pr-4 pt-1.5 pb-1.5'
                    }
                >
                    About me
                </h1>
                <article className={'text-[18px] md:text-[30px] pt-5'}>
                    Hello World! I&#39;m Paweł Fabrycki, the{' '}
                    <b className={'text-typescript mt-auto'}>TypeScript</b>{' '}
                    Programmer and Web Developer.
                    <br></br>
                    In free time I love reading mangas, watching anime, playing
                    games and airsofting.
                </article>
            </div>
            <div className={'inline-flex w-full'}>
                <div
                    className={
                        'border-[#a6e3a1] border-r-[3px] h-[350px] w-1/2 flex flex-col items-center'
                    }
                >
                    <h1
                        className={
                    ...
                    <div className={'flex items-center pt-1.5'}>
                        ...
                        <h1 className={'md:text-3xl pl-2.5'}>React</h1>
                    </div>
                    <div className={'flex items-center pt-1.5'}>
                        <svg
                            viewBox="0 0 32 32"
                        ...
                        <h1 className={'md:text-3xl pl-2.5'}>Tailwind</h1>
                    </div>
                    <div className={'flex items-center pt-1.5'}>
                        <svg
                            width="60px"
                        ...
                        <h1 className={'md:text-3xl pl-2.5'}>Next.js</h1>
                    </div>
                    <div className={'flex items-center pt-1.5'}>
                        <svg
                            viewBox="0 0 256 256"
                        ...
                        <h1 className={'md:text-3xl pl-2.5'}>TypeScript</h1>
                    </div>
                </div>
                <div className={'flex items-center flex-col w-1/2'}>
                    ...
                    >
                        ...
                        <Link
                            ...
                            target={'_blank'}
                            className={'flex items-center md:pl-10 pt-1.5'}
                        >
                            <svg
                                viewBox="0 0 256 256"
                                width={'60'}
                            ...
                            <h1 className={'md:text-3xl pl-2.5'}>Wakatime</h1>
                        </Link>
                    </div>
                </div>
            </div>
